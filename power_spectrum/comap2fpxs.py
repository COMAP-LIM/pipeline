                ...
                for feed1 in range(N_feed):
                    for feed2 in range(N_feed):
                        ...
                        if len(self.params.psx_rnd_file_list) > 0:
                            print("RND run, using loaded RND spectra for error bars!")
                            print(
                                cross_variable1,
                                cross_variable2,
                                feed1,
                        ...
                        chi3 = np.nansum(
                            (
                                xs[transfer_function_mask]
                                / xs_sigma[transfer_function_mask]
                            )
                            ** 3
                        )
                        ...
                        if self.params.psx_null_diffmap:
                            ...
                            accept_chi2 = (
                                np.abs(chi2[feed1, feed2])
                                < self.params.psx_chi2_cut_limit
                            )

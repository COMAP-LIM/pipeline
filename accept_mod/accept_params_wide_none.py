stats_cut = {
    ...
    'fknee_poly0': [float("nan"), float("nan")],  #[float("nan"), float("nan")], #[1e-4, 1e2],
    'alpha_poly0': [float("nan"), float("nan")],  #[float("nan"), float("nan")], #[-4.0, 2.0],
    'sigma_poly1': [float("nan"), float("nan")],  #[float("nan"), float("nan")], #[1e-5, 1e-2],
    'fknee_poly1': [float("nan"), float("nan")],  #[float("nan"), float("nan")], #[1e-4, 1e2],
    'alpha_poly1': [float("nan"), float("nan")],  #[float("nan"), float("nan")], #[-5.0, 3.0],
